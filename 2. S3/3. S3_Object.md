...
![introduction](../images/s3-object-overview.png)

S3 Objects là các tài nguyên đại diện cho dữ liệu chứ không phải hạ tầng.

Các đặc tính chính của S3 Object:

- **Etags** — một cách để phát hiện khi nội dung của một object bị thay đổi mà không cần tải nội dung xuống.
...
![introduction](../images/s3-object-etags.png)
...
![introduction](../images/s3-object-checksums.png)
...
![introduction](../images/s3-object-metadata.png)
...
![introduction](../images/s3-object-system-defined-metadata.png)
...
![introduction](../images/s3-object-user-defined-metadata.png)
...
![introduction](../images/s3-object-lock.png)
...
![introduction](../images/s3-object-lock-example.png)
...
![introduction](../images/s3-object-versioning.png)
...
![introduction](../images/s3-object-replication.png)
...
![introduction](../images/s3-archived-object.png)
